...
public class QueryDAO {
    ...
    public List<Document> wildcardQuery(String query) {
        ...
        try {
            result = getDocuments(QueryBuilders.wildcardQuery("message", "*" + query.toLowerCase() + "*"));
        } catch (Exception ex) {
            System.out.println("The exception was thrown in wildcardQuery method. {} " + ex);
        }
    ...
    public void deleteDocument(String id) {
        try {
            ...
            System.out.println("The exception was thrown in deleteDocument method. {} " + ex);
        }
    }
